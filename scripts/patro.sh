...
tmux send-keys -t 1 "cd ~/prog/patro/client" Enter
tmux send-keys -t 1 "nvim ." Enter

tmux new-window -t $sess_name: -n server
tmux send-keys -t 1 "cd ~/prog/patro/server" Enter
tmux send-keys -t 1 "nvim ." Enter
...
tmux send-keys -t 2 "cd ~/prog/patro/server" Enter
tmux send-keys -t 2 "make run" Enter

tmux new-window -t $sess_name: -n logs
tmux send-keys -t 1 "cd ~/prog/patro" Enter
